  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-md p-4 md:p-8">
      <div className="bg-white w-full max-w-5xl max-h-[90vh] rounded-[2rem] shadow-2xl overflow-hidden flex flex-col md:flex-row animate-in fade-in zoom-in duration-300">
        ...
        {/* Image Section */}
        <div className="md:w-3/5 bg-gray-50 relative min-h-[300px] md:min-h-0">
          <Image 
        ...
        {/* Info Section */}
        <div className="md:w-2/5 p-8 md:p-12 overflow-y-auto custom-scrollbar flex flex-col">
          <div className="flex justify-between items-start mb-6">
            <div className="space-y-1">
              ...
              <h2 className="text-3xl font-black text-gray-900 leading-tight">{artwork.title}</h2>
            </div>
            <button 
              onClick={onClose}
          ...
          <div className="flex items-center gap-6 mb-8 py-4 border-y border-gray-100">
            <div className="flex flex-col">
              ...
              <span className="text-2xl font-black text-[#C87941]">₱{artwork.price}</span>
            </div>
            <div className="flex flex-col">
              <span className="text-[10px] text-gray-400 font-bold uppercase tracking-wider mb-1 flex items-center gap-1">
          ...
          <div className="space-y-4 mb-10 flex-1">
            <h4 className="text-xs font-black text-gray-900 uppercase tracking-widest">Description</h4>
          ...
          <button 
            ...
            disabled={isAdding}
            className="w-full bg-[#1C4A5C] text-white py-4 rounded-2xl font-black text-sm hover:bg-[#143745] hover:scale-[1.02] active:scale-[0.98] transition-all shadow-xl shadow-[#1C4A5C]/20 flex items-center justify-center gap-3 group disabled:opacity-50"
          >
            {isAdding ? (
